<%-- 
    Document   : technologyedit
    Created on : 29 Jun, 2017, 11:41:02 AM
    Author     : user
--%>
<!doctype html>
    ...
    <div id="Adminpage">
		<div id="header">
			...
			<div>
                ...
                <!--Marketing Partners-->
                <br><br><br><br>                   
                <p style="color: blue;font-size: 40px;font-family: monospace;margin: 290px 0px 0px 290px"> Marketing Partners</p>
                <br><br><br>
                <div style="font-size: 28px"> 
                    <form name="partners" action="technologyeditdb.jsp" method="POST">
                        <table border="1" width="600"height="100" alignment="float" style="border-color: green;margin: -110px 10px 0px 280px">
                        <p style="color: blue;font-size: 20px;font-family: monospace;margin: 0px 0px 0px 425px">NO:</p>                        <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 600px">Name</p>
                        <input type="text" name="No" id="num" style= "height: 30px;width: 60px;margin: 0px 0px 0px 300px;font-size: 20px;" />&nbsp; &nbsp;<B></B>
                       <input type="text" name="partners" id="partner" style= "height: 30px;width: 300px;margin: 0px 0px 0px 0px;font-size: 20px;" />&nbsp; &nbsp;<B></B>
                       <br><br>
                       </table>
                ...
                <!--Licensed Users-->
                <br><br><br><br>                   
                <p style="color: blue;font-size: 40px;font-family: monospace;margin: -10px 0px 0px 250px"> Licensed users</p>
                <br><br><br>
                <div style="font-size: 28px"> 
                    <form name="licenseduser" action="licenseduserdb.jsp" method="POST">
                       <table border="1" width="1200"height="150" alignment="float" style="border-color: green;margin: -100px 10px 0px 180px">
                       <p style="color: blue;font-size: 20px;font-family: monospace;margin: 0px 0px 0px 225px">NO:</p>                        
                       <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 400px">Name</p>
                       <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 660px">Version</p>
                       <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 900px">Type</p>
                       <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 1100px">No. of License</p>
                       <input type="text" name="No" id="num" style= "height: 30px;width: 60px;margin: 0px 0px 0px 100px;font-size: 20px;" />&nbsp; &nbsp;
                       <input type="text" name="name" id="name" style= "height: 30px;width: 300px;margin: 0px 0px 0px 0px;font-size: 20px;" />&nbsp; &nbsp;
                       <input type="text" name="version" id="version" style= "height: 30px;width: 150px;margin: 0px 0px 0px 00px;font-size: 20px;" />&nbsp; &nbsp;
                       <input type="text" name="type" id="type" style= "height: 30px;width: 200px;margin: 0px 0px 0px 0px;font-size: 20px;" />&nbsp; &nbsp;
                       <input type="text" name="license" id="license" style= "height: 30px;width: 100px;margin: 0px 0px 0px 80px;font-size: 20px;" />&nbsp; &nbsp;
                        </table>
                       
                       <td><input type="submit" value="Add" name="Submit" style="margin: 50px 0px 0px 35%;height: 60px;width: 100px;font-size: 24px;font-style: italic"/></td>
                    </form>
                </div>
        </div><!--box close-->
