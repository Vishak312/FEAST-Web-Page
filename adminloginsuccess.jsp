<%-- 
    ...
    Created on : 27 Jun, 2017, 2:23:11 PM
    Author     : user
--%>
    ...
    <div id="Adminpage">
		<div id="header">
			...
			<div>
                ...
                <!--images uploading for scrolling-->
                <br><br><br><br>                   
                <p style="color: blue;font-size: 40px;font-family: monospace;margin: 290px 0px 0px 290px"> Upload Banner Image</p>
                <br><br><br>
                <div style="font-size: 28px"> 
                    <form name="image" action="imagein.jsp" method="POST">
                   
                <input type="text" name="image" id="image" style= "height: 30px;width: 300px;margin: 0px 0px 0px 250px" />&nbsp; &nbsp;<B>image</B>
                <br><br>
                <td><input type="submit" value="Add" name="Submit" style="margin: 0% 0px 0px 30%;height: 60px;width: 100px;font-size: 24px;font-style: italic"/></td>
                    </form>
                </div>
               
            <!-- notice board content content-->       
                    <table border="1" width="300" alignment="" style="border-color: tomato;margin:  -200px 00px 0px 1190px;text-indent: 0pt"> 
            ...
            <form name="notice" action="notice.jsp" method="POST">
                <textarea type ="text" name="notice" id="notice" rows="5" cols="25" style= "margin: 40px 0px 0px 1110px;font-size: 16px"></textarea>
                <br><br>
                <td><input type="submit" value="Notice" name="Submit" style="margin: 0% 0px 0px 80%;height: 60px;width: 100px;font-size: 24px;font-style: italic"/></td>
