<%-- 
    Document   : collaborationedit
    Created on : 29 Jun, 2017, 2:33:52 PM
    Author     : user
--%>
<!doctype html>
    ...
    <div id="Adminpage">
		<div id="header">
			...
			<div>
                ...
                <!--Marketing Partners-->
                <br><br><br><br>                   
                <p style="color: blue;font-size: 40px;font-family: monospace;margin: 290px 0px 0px 290px"> Collaborations</p>
                <br><br><br>
                <div style="font-size: 28px"> 
                    <form name="partners" action="collaborationeditdb.jsp" method="POST">
                        <table border="1" width="600"height="100" alignment="float" style="border-color: green;margin: -80px 10px 0px 300px">
                        <p style="color: blue;font-size: 20px;font-family: monospace;margin: 0px 0px 0px 425px">NO:</p>                        
                        <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 600px">Name</p>
                        <input type="text" name="No" id="num" style= "height: 30px;width: 60px;margin: 0px 0px 0px 300px;font-size: 20px;" />&nbsp; &nbsp;<B></B>
                       <input type="text" name="collab" id="collaboration" style= "height: 30px;width: 300px;margin: 0px 0px 0px 0px;font-size: 20px;" />&nbsp; &nbsp;<B></B>
                        </table>
