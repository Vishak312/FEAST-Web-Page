    ...
    <div id="Adminpage">
		<div id="header">
			...
			<div>
                ...
                <br><br><br><br>                   
                <p style="color: blue;font-size: 40px;font-family: monospace;margin: 290px 0px 0px 290px"> NEWS</p>
                <br><br><br>
                <div style="font-size: 28px"> 
                    <form name="news" action="newseditdb.jsp" method="POST">
                   
                <textarea type ="text" name="news" id="news" rows="5" cols="25" style= "margin:  -50px 0px 0px 250px;font-size: 16px;width: 500px"></textarea>

                <br><br>
                <td><input type="submit" value="Add" name="Submit" style="margin: 0% 0px 0px 40%;height: 60px;width: 100px;font-size: 24px;font-style: italic"/></td>
                    </form>
                </div>
