<%-- 
    Document   : video
    Created on : 16 Mar, 2017, 10:35:24 AM
    Author     : user
--%>
...
<html>
	...
	<title>FEAST-Video Gallery</title>
    ...
    <body>
		...
		<div id="header">
          ...
          <br><br>
            ...
            <!div style="width: 500px;height: auto;padding: 0px 0px 0px 0px; border: 5px;border-color: green;margin: -60px 10px 18px 100px">;
                    ...
                    <table border="1" width="" alignment="center" style="margin:  30px 10px 120px 80px;background: white"> 
                        <tbody>
        ...
        <!--buttons-->    
            ...
            <sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/feastforum" user="root" password="root"/> 
                    ...
                    <table border="10" width="300" alignment="" style="border-color: tomato;margin:  -550px 00px 0px 1190px;text-indent: 0pt"> 
