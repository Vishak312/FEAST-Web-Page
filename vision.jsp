    ...
    <body>
		...
		<div id="header">
            ...
            <div id="body" class="home">   
                ...
                <img src="images/banner2.png"  style="margin: 00px 0px 0px 100px"/>              
            <div class="boxvision">
                <!--buttons-->    
             <div class="blogvision" style="">
                 <!div class="zoom_img">
                <ul>
            ...
            <div style=" border: 00px;margin: 180px 10px 18px 240px;">
                <br><br><br>
                <img src="images/vision.png" />
                </div>
                    <div style="width: 800px;height:50px;padding: 0px 0px 0px 50px; border: 5px;margin:  0px 10px 250px 220px;text-indent: 400px; font-size: 16px;text-align: justify;color: black; font-weight: bold">          
                        <table border="1" width="900" alignment="center" style="border-color: green;background: lightyellow;">
                            <tbody>
                                <tr>
                                    <td>
                                        <p>
                                            <br>
                                        <div style="text-indent: 50pt; font-size: 24px;font-family: monospace;color: black;">
                                            Achieve self reliance in the software technology domain<br>
                                        </div>
                                        <br>
                                        <div style="text-indent: 80pt;font-size: 24px;font-family: monospace; color: black">
                ...
                <table border="1" width="300" alignment="" style="border-color: tomato;margin:  -350px 00px 0px 1195px;text-indent: 0pt"> 
                  <thead>
                        <tr>
