<%-- 
    Document   : photoedit
    Created on : 30 Jun, 2017, 2:00:19 PM
    Author     : user
--%>
<!doctype html>
    ...
    <div id="Adminpage">
		<div id="header">
			...
			<div>
                ...
                <br><br><br><br>                   
                <p style="color: blue;font-size: 40px;font-family: monospace;margin: 290px 0px 0px 290px"> Photo Gallery</p>
                <br><br><br>
                <div style="font-size: 28px"> 
                    <form name="partners" action="photoeditdb.jsp" method="POST">
                        <table border="1" width="820"height="100" alignment="float" style="border-color: green;margin: -80px 10px 0px 300px">
                        <p style="color: blue;font-size: 20px;font-family: monospace;margin: 0px 0px 0px 500px">Page</p>                        
                        <p style="color: blue;font-size: 20px;font-family: monospace;margin: -30px 0px 0px 850px">Name</p>
                        <input type="text" name="page" id="address" style= "height: 30px;width: 300px;margin: 0px 0px 0px 300px;font-size: 20px;" />&nbsp; &nbsp;<B></B>
                       <input type="text" name="name" id="name" style= "height: 30px;width: 300px;margin: 0px 0px 0px 0px;font-size: 20px;" />&nbsp; &nbsp;<B></B>
                        </table>
